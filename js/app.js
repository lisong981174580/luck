...
$("div.top").css("width",(bodyWidth.substring(0,bodyWidth.length-2)-380)+"px");
...
$("document").ready(function(){
	...
	if(localStorage.getItem("itemk")){
		...
		$("div.item").css("fontSize",(localStorage.getItem("itemk"))/2.5+"px");
	}
    //本地存储item高度信息
    ...
    //回显设定item宽高
	$("#itemk").attr("placeholder",$(".i1").css("width").substring(0, ("placeholder",$(".i1").css("width").length-2)));
	$("#itemg").attr("placeholder",$(".i1").css("height").substring(0, ("placeholder",$(".i1").css("height").length-2)));
